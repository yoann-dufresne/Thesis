...
C'est un domaine de terminaison qui permet le décrochage du peptide complètement formé.
...
Les domaines responsables de ces transformations sont appelés domaines d'\textit{épimérisation}.
...
\paragraph{}Les PKS (Polyketyde Synthase) sont, tout comme les NRPS, des enzymes modulaires permettant de synthétiser des polymères complexes par assemblage de monomères.
...
Ces zones conservées ont permis de déterminer des coordonnées fixes entre domaines A et ansi de créer le code de Stachelhaus.
...
Ce lien fort entre clusters de gènes et NRP est très intéressant mais n'est disponible que pour 67 entrées.
