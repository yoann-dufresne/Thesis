...
The software re-generate the manual annotations with an excellent sensibility in a very short amount of time.

The Norine database, the reference knowledge base about special polymers called Non Ribosomal Peptides (NRP), is developed by our research group.
s2m, executed on the Norine database, alerted us about wrong manually entered annotations.
So, s2m create new annotations and is also capable of correcting already existed ones.
