...
\subsection{Les domaines secondaires}

\paragraph{}Dans cette section je vais décrire quelques-uns des domaines optionnels les plus fréquents dans les NRPS.

\subsubsection{La fonction d'épimérisation (domaines E et C/E)}

\paragraphe{}Lors de la description des domaines LCL et DCL, j'ai rapidement évoqué l



\subsection{Liens avec les PKS}
