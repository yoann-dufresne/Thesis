...
Parmis ceux-ci, certains gènes servent à modifier les NRP après leur production.
...
Ces deux atomes sont innabituels pour des NRP et ne sont pas initialement présent au sein de leur monomères de rattachement.
Il n'existe pas non plus de domaine NRPS capable d'inclure ce genre d'atomes.
Van Wageningen dans l'article précédamment cité montre également que deux enzymes issues du cluster de gène de la NRPS, sont responsables de ces incorporations.
...
\begin{itemize}
  \item La synthèse de monomères en modifiant des composants de l'environement (création de vancosamine)
  \item La création de liaison entre monomères de l'environement et NRP (Les sucres de la Vancomycine)
...
\begin{figure}[h!]
  \begin{center}
    ...
    La longue chaine carbonée de la première étape est créée par une répétion successive de 9 fois le même module.
...
Soit la PK est créé séparément du NRP et les deux sont liés post-synthèse par des enzymes similaires aux enzymes décoratrices décrites précédamment.
