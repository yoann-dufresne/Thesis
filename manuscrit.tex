...
La vancosamine n'étant pas naturellement présent dans l'environnement de l'organisme producteur, l'une des enzymes est dédiée à la création de ce sucre à partir du NDP-4-keto-6-deoxyglucose.
...
\paragraph{}La détection et l'identification des gènes codant pour les domaines est le coeur de l'annotation des NRPS.
...
gros avantage de cette représentation est d'inclure directement dans les labels des noeuds ce qui touche à l'arrité entre noeuds.
La fonction
...
\begin{figure}
  \includegraphics[width=300px]{Figures/s2m/indexation/glouton.png}
  \caption{\label{arrite}Arrité restante pour les différents noeuds d'un graphe chimique simple}
\end{figure}
