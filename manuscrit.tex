...
Rappelons que de ce paramêtre découlera le temps de calcul pour les peptides mais que la qualité des résultats ne variera pas.
...
Pour quelques peptide, le temps est complété par une petite phase de modulation qui ne prend que quelques millisecondes.
