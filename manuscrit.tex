...
jusqu'à disparaître complètement (ce qui est peu pratique pour la comparaison) alors que d'autre vont grossir de plus en plus
...
\begin{figure}
  \includegraphics[width=300px]{Figures/s2m/residus/cys_exemple.pdf}
...
\begin{figure}
  \includegraphics[width=300px]{Figures/s2m/pavage/redction.pdf}
