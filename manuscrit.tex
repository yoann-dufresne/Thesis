...
Dans tous les cas, il est possible de trouver au moins une molécule (pas forcément NRP puisque s2m s'applique à n'importe quel type de polymères) ne répondant pas à l'un de ces critères et c'est pour cela que nous ne les utiliserons pas.
...
\begin{figure}[h!]
  \begin{center}
    \includegraphics[width=450px]{Figures/s2m/results/cyclotheonamide.png}
