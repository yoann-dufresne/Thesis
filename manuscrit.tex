...
Cette voie de synthèse comporte une étape supplémentaire (Voir figure TODO).
...
\paragraph{}TODO : schéma synthèse globale
...
Comme nous le verrons plus tard lors de la description des modules NRPS Cy, l'atome de soufre peut également intervenir dans une cyclisation entre deux monomères en perdant son atome d'hydrogène de la même manière que lors d'un pont disulfure.

\paragraph{TODO : Liaisons soufre}
...
Dans le cas d'un Benzene, c'est la présence d'un oxygène accroché au cycle qui permettra une affinité avec les carbones voisins.

\paragraph{TODO : cycles aromatiques}

\paragraph{}Le troisième type de liaison concerne les sucres.
Nous condensserons toutes les liaisons sucre sous le nom de liaisons ``ose''.
Ces liaisons interviennent sur les sucres sur le groupement OH présent sur un carbone voisin à l'oxygène inclus dans le cycle.

\paragraph{TODO : liaisons sucre}

\paragraph{TODO : a réécrire/vérifier}Enfin, le dernier type de liaison que nous alons décrire implique au moins un monomère faisant partie de la catégorie des sucres (Glucose ou Arabinose par exemple).
...
Dans un premier temps, ce bras amène le monomère capturé par le domaine A voisin pour le lier de manière covalente à la synthétase.
