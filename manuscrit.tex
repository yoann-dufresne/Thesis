...
\paragraph{}Une protéine assemblée se replie sur elle même et c'est cette forme repliée qui détermine son activité. C'est plus
précisément les proprités des éléments en contact avec l'extérieur de la protéine (les atomes qui ne se retrouvent pas enfermé
au milieu du repliement) qui déterminent les propriétés de celle-ci. Ces propriétés sont donc très dépendantes du repliement et
des types de radicaux exposés.

\subsection{Vue globale de la synthèse non ribosomique}

\subsubsection{Une synthèse à quatre niveaux}

% Introduire les termes pour NRP et NRPS

\subsubsection{Les propriétés générales des NRP}
