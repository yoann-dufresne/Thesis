...
Ces données sont toutes des prédictions de structures NRP et ces strcutures devront donc être utilisées avec précaution.
...
\begin{figure}[h!]
  \begin{center}
    \includegraphics[width=450px]{Figures/s2m/results/enniatinI_corrections.png}
