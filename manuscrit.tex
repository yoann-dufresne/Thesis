...
\paragraph{}Commençons par définir précisément le problème MCS.
Comme le nom l'indique, le problème MCS cherche à trouver la sous partie commune maximale de deux graphes.


% \paragraph{}Commençons par définir mathématiquement le sous graphe maximum commun.
% 
...
\paragraph{}De la même manière que pour le MCS, définissons mathématiquement ce qu'est l'Isomorphisme de Sous-graphe
