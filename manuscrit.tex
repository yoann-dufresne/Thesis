...
problèmes NP-complets de Karp~\cite{karp_reducibility_1972}. Il n'existe donc actuellement aucune méthode de résolution de ce problème en temps polynomial.
Pour les cas les plus difficiles, il est donc nécessaire de trouver un moyen plus rapide d'obtenir une solution.
...
En faisant cela on reporte la difficulté du problème sur les critères de tri de la liste mais on garantit une très grande rapidité d'exécution.
...
La structure en boucle avec l'isomorphisme light sort, pour la plupart des cas, très vite de l'algorithme.
