...
Sur le squelette est ancré une chaine latérale variant d'un acide aminé à l'autre, leur donnant leur spécificités (Voir figure TODO).
L'un des côté du squelette contient un groupement amine ($NH_2$) et l'autre un groupement carboxyle ($C(=O)OH$).
