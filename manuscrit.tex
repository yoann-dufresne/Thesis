...
\begin{figure}[!h]
  \begin{center}
    ...
    En utilisant la règle de découpe à appliquer pour les hydroxyl, une ambiguité et une erreur apparaissent.
...
Cependant certaine réactions effectuées au sein des NRP ne permettent pas de découper entièrement le peptide avec la seule règle énoncée précédammant.
