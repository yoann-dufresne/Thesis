...
\paragraph{Pavage des monomères}Une fois les monomères détectés, il est nécessaire de prendre une décision pour les parties du polymère où plusieurs d'entre eux entre en conflit.
...
isomorphismes découverts par atome.
...
\begin{itemize}
	...
	\item Les liens entre atomes : Les liens représentent les voisinages de deux cases.
Si deux cases sont voisines (voisinage de Manhattan), alors un lien existe entre les deux atomes qui les représentent.
...
par l'algorithme du simplexe~\cite{murty_linear_1983}. Depuis la publication, de nombreuses variantes de l'algorithme ont été
...
>>>>>>> 8c9a6c9c7d5582e49c30aa7e592f59137e9fab36
...
<<<<<<< HEAD
Lorsque la chaine est entièrement générée de manière gloutonne, chaque isomorphisme prend environ 8 centièmes de ms.
...
Les monomères non trouvables dans un peptide donné (même ceux étant constitués de plusieurs dizaines d'atomes), peuvent déjà tous être éliminés après 3 atomes si les chaines sont correctement formées.
Il n'est donc pas nécessaire de pré-calculer (sur nos données) des chaines avec un k supérieur à 3.
