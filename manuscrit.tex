...
La seconde sous-catégorie présentera les moyens d'archivage et de mise à disposition des informations récolétées par les outils d'annoation.
...
Il exise également des techniques spécialisées pour détecter directement des cluseters de gène de métabolites secondaires.
...
\paragraph{}De nombreux autres logiciels encore plus spécilisés existent.
...
L'utilisation de HMM en faible nombre permet à ces logiciels d'être extrémement rapide pour les recherches.
