...
En 1999, Stachelhaus et al. publient un article analysant la structure de nombreux domaines A~\cite{stachelhaus_specificity-conferring_1999}.
...
Pour constituer cette liste, nous nous sommes aidé du portail des outils bioinformatiques dédiés aux métabolites secondaires~\cite{weber_secondary_2016}.
...
Enfin les quantités et la pureté nécessaires dans les échantillons ne sont souvent pas atteignables pour des chaînes de production NRP.
