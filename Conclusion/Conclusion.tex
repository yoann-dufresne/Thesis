...
Globalement, s2m est un logiciel rapide et efficace (section \ref{temps_calcul}), ce qui nous a permis de l'utiliser comme controle qualité puis pour l'analyse sur de grands jeux de données.
