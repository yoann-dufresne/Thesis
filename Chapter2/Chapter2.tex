...
En regardant maintenant la seconde chaîne, on se rend compte que le nombre de ces isomorphismes intermédiaires est bien plus faible grâce à la sélectivité de l'étiquette ``rouge'' recherchée en tout premier (5 isomorphismes intermédiaires sont étendus).
...
\begin{figure}[!ht]
  \begin{center}
    ...
    Le taux de filtrage d'un ajout de n\oe{}ud dans un motif est alors défini comme le nombre de détections du motif initial dans la base divisé par le nombre de détections du motif étendu.
...
La solution est alors tellement éloignée de la réalité qu'il devient inatteignable pour notre construction algorithmique.
...
C'est à nouveau un résultat que nous attendions puisque la recherche \textit{light} ne s'appuie que sur une faible diversité d'étiquette sur les n\oe{}uds (voir les sections \ref{selectiv_p} pour l'influence du nombre d'étiquettes et \ref{light_p} pour la recherche light).
