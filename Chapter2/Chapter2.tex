...
Pour prédire l'activité, les auteurs utilisent plusieurs classifieurs présent dans la librairie WEKA~\cite{hall_weka_2009}.
...
\begin{figure}[!ht]
  \begin{center}
    ...
    Le nombre de solutions intermédiaires représente les nombres successif d'isomorphismes de sous}
  \end{center}
\end{figure}
