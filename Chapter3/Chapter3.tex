...
Actuellement, pour apprendre plus de détails sur les structures chimiques des molécules, sont présents des liens vers PubChem~\cite{kim_pubchem_2015} et UniProt~\cite{consortium_uniprot:_2015}.
...
Les regroupements permettent de trouver des peptides contenant des monomères proches mais pas identiques.
...
Nous nous appuierons sur des travaux de revue spécialisés pour les NRP~\cite{kries_biosynthetic_2016}.
...
Les techniques que nous avons présentées ici sont toutes très encourageantes pour l'avenir de la biologie de synthèse des NRP.
...
Pour le moment, le modèle que nous avons développé ne prend en compte que les domaines A.
...
Nous supposons également que la distance de Jaccard n'est pas forcément très adaptée au problème et il nous faudra tenter l'utilisation d'alternatives issues des systèmes de recommandation classiques.
