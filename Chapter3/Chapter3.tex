...
Les NRP étant une source très riche d'antibiotiques, de nombreuses équipes essayent de créer de nouvelles molécules à partir de NRP pour avoir de nouvelles molécules contres lesquelles, les micro-organismes ne présentent pas de résistance.
...
En modifiant certains acides aminés composant un domaine A, la spécificité de ce domaine change.
...
Malheureusement, ces modifications ne sont pas si directes car les modules doivent respecter des contraintes spatiales et physico-chimiques pour que la NRPS ait une cohérence structurelle.
...
Comme nous l'avons vu précédemment, modifier un domaine A est déjà très difficile et nécessite beaucoup de précision.
...
La première piste que nous avions envisagée était de rassembler des données NRPS sûres (annotées manuellement) et de les mettre en relation avec les données NRP de Norine.
